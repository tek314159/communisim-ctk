    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md">
                ...
                <div id="petdash">
                    <p>
                    <button type="button" class="btn btn-primary" id="soothebutton">Soothe Pet</button>
                    </p>
                </div>
                ...
                <div id="devdash">
                    ...
                    <p>Year <span id="years">1</span> | Day <span id="counter"></span> | 
                    Population: <span id="population"></span> (<span id="fpop"></span> F / <span id="mpop"></span> M) 
                    CC: <span id="coicou"></span>
                    </p>
...
var socialNormConstant = 1000; // lower number makes it easier to break social norms
...
function updateMetaDash() {
    $("#metapanel").html("Project Material: " + projectMaterial + "<br>");
}
