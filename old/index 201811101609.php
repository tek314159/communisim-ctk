    ...
    specialEvents.push(
        {
            ...
            "effect": function() {
                ...
                postEventQueue.push([counter+365,function(){incRestrict=3;textLog.push([counter, "<strong>taboo porn</strong> is no longer popular."])}])
            },
...
var specialEvents = [
    ...
    },
    {
        ...
        "effect": function() {
            ...
            postEventQueue.push([counter+180,function(){socialNormConstant = orisoc;kissBackReq = orikbr;textLog.push([counter, "<strong>water</strong> has returned to normal."])}])
        },
        "flavortext":"Something happens!!"
    },
    {
...
function fullCharInfoPanel(char) {
    ...
    for (var h=0;h<raray.length;h++) {
        ...
        ra += ("<tr><th scope='row'>" + (h+1) + "</th><td>" + raray[h].rName + rela + "</td><td>" + raray[h].friendship + "</td><td>" + raray[h].attraction + "</td><td>" + raray[h].romance + "</td><td>" + raray[h].interactions + "</td><td>" + raray[h].coitus + "</td></tr>")
    }
    var aa = "";
    var aaray = [];
    ...
    var pnl = (
        ...
        "<div class='row'><div class='col'>" +
        '<p>Relationships:</p><table class="table table-sm"> <thead> <tr> <th scope="col"></th> <th scope="col">Name</th> <th scope="col">Friendship</th> <th scope="col">Attraction</th><th scope="col">Romance</th><th scope="col">Interactions</th><th scope="col">Coitus</th> </tr> </thead><tbody>' +
        ra + "</tbody></table>" +
        "</div></div>"  // close out the row
        // "<div class='row'><div class='col'>" +
        // "Favorite Activities:<br><ul>" +
