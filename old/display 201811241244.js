    ...
    <div class="gamepage" id="mainpage">
        <div class="row">
            <div class="col-md">
                <div id="stats">
                    ...
                    Year <span id="years" class="years">1</span> | Day <span class="counter" id="counter"></span> | Population: <span class="population" id="population"></span> (<span class="fpop" id="fpop"></span> F / <span class="mpop" id="mpop"></span> M) <!--  CC: <span id="coicou"></span> -->
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md" id="status-dash">
                ...
                <button type="button" class="btn btn-primary" id="historybutton" onClick="saveHistory()">Save History</button></div>
                <div id="textlog"></div>
            </div>
        </div>
    </div>
...
function createLocalePanel(id) {
    var su = "";
    var len = localeList[id].majorSurnames.length;
    for (var i=0;i<len;i++) {
        if (i == len-1) {
            su += (localeList[id].majorSurnames[i]);
        } else {
            su += (localeList[id].majorSurnames[i] + ", ");
        }
    }
