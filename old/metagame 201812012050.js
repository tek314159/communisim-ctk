...
function OtherLocale() {
    ...
    // this.population = randomInt(LOCVAR.localeMinPop, LOCVAR.localeMaxPop);
...
// OtherLocale.prototype.populationGrowth = function() {var growth = 1; if (Math.floor(this.population * 0.003) > 1) {growth = Math.floor(this.population * 0.003)}; this.population += growth} // annual growth
