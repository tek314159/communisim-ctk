...
function gameSetupSaveTest() {
    ...
    $("#startTime").text(gameStartTime);
    dLc();
    if (window.localStorage.getItem('comSaveGame') == 1) {
        restoreFromSave();
    } else {
...
function saveGame() {
    ...
    console.log("setting");
    window.localStorage.setItem('comSaveGame', 1);
    window.localStorage.setItem('npcArray', JSON.stringify(npc));
    window.localStorage.setItem('currentCounter', counter);
    window.localStorage.setItem('liveNpcArray', JSON.stringify(liveNPC));
    window.localStorage.setItem('textLogArray', JSON.stringify(textLog));
    window.localStorage.setItem('romanticTypesArray', JSON.stringify(romanticTypes));
    window.localStorage.setItem('socialNormsArray', JSON.stringify(socialNorms));
    window.localStorage.setItem('specialEventsArray', JSON.stringify(specialEvents));
    window.localStorage.setItem('regActivitiesArray', JSON.stringify(regActivities));
    window.localStorage.setItem('locationListArray', JSON.stringify(locationList));
    window.localStorage.setItem('localeListArray', JSON.stringify(localeList));
    window.localStorage.setItem('birthRate', JSON.stringify(birthRate));
    window.localStorage.setItem('stats', JSON.stringify(stats));
    window.localStorage.setItem('gameStartTime',JSON.stringify(gameStartTime));
    window.localStorage.setItem('pet',JSON.stringify(pet));
    window.localStorage.setItem('petTimer', JSON.stringify(petTimer))
    window.localStorage.setItem('monumentActive', monumentActive);
    window.localStorage.setItem('leaderActive', leaderActive);
    window.localStorage.setItem('disPointThreshold', disPointThreshold);
    window.localStorage.setItem('disPoints', disPoints);
    window.localStorage.setItem('discoveryActive', discoveryActive);
    window.localStorage.setItem('projectMaterial', projectMaterial);
    window.localStorage.setItem('teamLeader', teamLeader);/* 
    console.log("getting");
    var npccopy = JSON.parse(window.localStorage.getItem('npcArray'));
    var countercopy = window.localStorage.getItem('currentCounter');
    var livenpccopy = JSON.parse(window.localStorage.getItem('liveNpcArray'));
    var textlogcopy = JSON.parse(window.localStorage.getItem('textLogArray'));
    //console.log("displaying");
    //console.log(window.localStorage.getItem('comSaveGame'));
    //console.log(npccopy);
    for (var property in npccopy[0]) {
        if (npccopy[0].hasOwnProperty(property)) {
            // do stuff
            console.log(npccopy[0][property]);
        }
    }
    var uiop = new person;
    for (var property in npccopy[0]) {
        if (npccopy[0].hasOwnProperty(property)) {
            // do stuff
            uiop[property] = npccopy[0][property];
        }
    }
    //console.log(uiop);
    //console.log(countercopy);
    //console.log(livenpccopy);
    //console.log(textlogcopy); */
}
...
function restoreFromSave() {
    ...
    counter = parseInt(window.localStorage.getItem('currentCounter'));
    monumentActive = parseInt(window.localStorage.getItem('monumentActive'));
    leaderActive = parseInt(window.localStorage.getItem('leaderActive'));
    disPointThreshold = parseInt(window.localStorage.getItem('disPointThreshold'));
    disPoints = parseInt(window.localStorage.getItem('disPoints'));
    discoveryActive = parseInt(window.localStorage.getItem('discoveryActive'));
    projectMaterial = parseInt(window.localStorage.getItem('projectMaterial'));
    teamLeader = parseInt(window.localStorage.getItem('teamLeader'));
    textLog = JSON.parse(window.localStorage.getItem('textLogArray'));
    liveNPC = JSON.parse(window.localStorage.getItem('liveNpcArray'));
    birthRate = JSON.parse(window.localStorage.getItem('birthRate'));
    stats = JSON.parse(window.localStorage.getItem('stats'));
    gameStartTime = JSON.parse(window.localStorage.getItem('gameStartTime'));
    pet = JSON.parse(window.localStorage.getItem('pet'));
    //petTimer = JSON.parse(window.localStorage.getItem('petTimer'));
    locationList = JSON.parse(window.localStorage.getItem('locationListArray'));
    var npccopy = JSON.parse(window.localStorage.getItem('npcArray'));
    console.log(npccopy);
    console.log(npc);
    for (let i=0;i<npccopy.length;i++) {
        ...
        console.log("thefollowingis npci");
        console.log(i);
        console.log(npc[i]);
        console.log(npc[0]);
        //console.log("restored " + npc[i].firstName);
        console.log(npc);
    }
    console.log(npc);
    var loccopy = JSON.parse(window.localStorage.getItem('localeListArray'));
    ...
    console.log(npc);
    var romcopy = JSON.parse(window.localStorage.getItem('romanticTypesArray'));
    restoreArray(romanticTypes, romcopy);
    console.log(npc);
    var normcopy = JSON.parse(window.localStorage.getItem('socialNormsArray'));
    restoreArray(socialNorms,normcopy);
    var eventcopy = JSON.parse(window.localStorage.getItem('specialEventsArray'));
    restoreArray(specialEvents,eventcopy);
    var activcopy = JSON.parse(window.localStorage.getItem('regActivitiesArray'));
