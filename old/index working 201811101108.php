...
var specialEvents = [
    ...
    },
    {
        ...
        "effect": function() {
            ...
            addNPC();
            textLog.push([counter, "the community welcomed " + npc[npc.length-1].firstName + ", a <strong>mysterious stranger</strong>, into their midst."]);
        },
        "flavortext":"Something happens!!"
    },
    {
