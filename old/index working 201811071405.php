...
function whupEee(persona, personb) {
    ...
    if (persona.rTwo[npc.indexOf(personb)].attraction > 100 && w == 0 && randomInt(1,3) == 1) {
...
function describeRelationship(persona, personb) {
    var description = "";
    // relatives
    if (persona.relatives[npc.indexOf(personb)] != undefined && persona.rTwo[npc.indexOf(personb)] != undefined) {
...
function sortDash(method) {
    $divs = $("div.charcard").slice(0);
    $divs.sort(function(a,b){
        if ($(a).attr("title")<$(b).attr("title")) {return -1};
        if ($(a).attr("title")>$(b).attr("title")) {return 1};
        return 0;
    });
    if (method=="id") {
