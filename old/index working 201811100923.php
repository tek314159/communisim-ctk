...
var specialEvents = [
    ...
    },
    {
        ...
        "effect": function() {
            ...
            postEventQueue.push([counter+365,function(){socialNormConstant = orisoc;kissBackReq = orikbr;textLog.push([counter, "<strong>water</strong> has returned to normal."])}])
        },
        "flavortext":"Something happens!!"
    },
    {
        ...
        "effect": function() {
            addNPC();
            textLog.push([counter, "the community welcomed a <strong>mysterious stranger</strong> into their midst."]);
        },
        "flavortext":"Something happens!!"
    },
    {
        ...
        if (personb.rTwo[npc.indexOf(persona)].attraction > kissBackReq) {
            ...
            if (randomInt(1,5) == 1) {
                if (persona.rTwo[npc.indexOf(personb)].coitus == 0) {
                    ...
                    var incsuf = "";
                    if (persona.relatives[npc.indexOf(personb)] != undefined) {incsuf = (" They committed <strong>incest</strong>.")}
                    textLog.push([counter, (persona.firstName + " (age " + persona.ageInYears() + ") and " + personb.firstName + " (age " + personb.ageInYears() + ")  slept together for the first time." + incsuf)]);
                }
...
function killCharacter(char) {
    textLog.push([counter, (char.firstName + " died at age " + char.ageInYears() + ".")]);
